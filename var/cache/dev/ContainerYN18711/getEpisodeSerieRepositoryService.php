 ...
 */
class getEpisodeSerieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EpisodeSerieRepository' shared autowired service.
     *
     * @return \App\Repository\EpisodeSerieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EpisodeSerieRepository.php';

        return $container->privates['App\\Repository\\EpisodeSerieRepository'] = new \App\Repository\EpisodeSerieRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

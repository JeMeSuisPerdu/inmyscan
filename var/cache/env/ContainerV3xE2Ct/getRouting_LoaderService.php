 ...
 */
class getRouting_LoaderService extends App_KernelEnvDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AttributeRouteControllerLoader('env');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'env'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'env'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'env'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'env'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'env'));
